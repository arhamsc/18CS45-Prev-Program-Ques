...
Methods to avoid deadlock: 
    ...
    structure. If possible, keep your code free form locks. For example, instead of using synchronized A
    rrayList use the ConcurrentLinkedQueue.
...
/*Here, the cursor is forver shown in the output as a deadlock occurs when d1() and d2()(which are synchronized for a and b) 
